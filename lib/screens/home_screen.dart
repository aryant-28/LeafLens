  ...
  void initState() {
    ...
    _screens = [
      HomeContent(
        onScanLeafPressed: () => setTab(1),
        onChatPressed: () => setTab(2),
        onReminderPressed: () => Navigator.push(
          context,
            ...
            children: AnimationConfiguration.toStaggeredList(
              ...
              children: [
                ...
                _buildAnimatedFeatureCard(
                  ...
                  delay: 700,
                  icon: Icons.alarm,
                  title: localization?.translate('reminders') ?? 'Reminders',
                  description: localization?.translate('reminder_description') ??
                      'Set reminders to check your plants regularly',
